export default {
  ...
  message: {
    verificationCode1: "인증코드 요청을 먼저 진행해주세요.",
    verificationCode2: "인증번호를 입력해주세요.",
    verificationCode3: "인증번호를 확인후 다시입력해주세요.",
    vote: "본인 컨텐츠에는 투표를 할 수 없습니다.",
    entryPage1: "이미지는 10MB이하로 선택해주세요.",
    entryPage2: "빠짐없이 모두 작성후에 체크버튼을 눌러주세요.",
    entryPage3: "등록되었습니다.",
    entryPage4: "수정이 완료되었습니다.",
    myEntry1: "삭제되었습니다",
    ...
    battleEntry:
      "도난당한 아이템의 등록은 우리의 이용 약관에 위반되며 ECO NFT에서는 허용되지 않습니다. 도난당한 아이템의 보상은 취소될 수 있습니다.",
    ...
    serviceChecking: "Battle 서비스 준비중",
    ...
    addressCaution2:
      "matic (폴리곤 메인넷), ESG (이더리움) 메인넷만 입출금이 가능합니다.",
    addressCaution3:
      "사용자가 입력을 잘못한 경우 서비스 제공자는 책임을 지지 않습니다.",
    withdraw: "출금",
    ...
    successReferralTitle: "추천인 코드 입력 완료!",
    successReferral: "추천인에게 1000ESG point가 적립되었습니다!",
