...
//   console.log("🚀 ~ getNftListTime ~ response호출3:", response);
...
//   console.log("🚀 ~ compareNftTime ~ nftResponse: 호출2", nftResponse);
...
//   console.log("compareNft에서 시간은", nftLatestTime, nftResponse.status);
