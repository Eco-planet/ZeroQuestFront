<template>
  <div>
    ...
    <div class="p-9 text-2xl text-black">
      ...
      <div>
        <div v-if="locale === 'kr'" class="mt-32 mb-16 font-bold">아파트에서 살고있다면?<br> ‘계단오르기’NFT를 통해 <br>ESG 포인트 획득이 가능합니다
        </div>
...
const handleTossPayment = () => {
  ...
  // Flutter 앱 내에 정의된 JavaScript 핸들러 호출
  window.flutter_inappwebview.callHandler("handleTossPayBtn", dataToSend).then((res) => {
    console.log('res',res);
  });
}
